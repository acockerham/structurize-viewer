...
function readBlueprintFromNBTData(nbtdata) {
  // Get rid of all the annoying stuff basically

  var blueprint = new Blueprint();
  blueprint.regions = new Array();
  ...
  for (let regionName in regions) {
    ...
    var blueprintRegion = new BlueprintRegion(width, height, depth);
    blueprintRegion.blocks = blocks;
    blueprintRegion.blockPalette = blockPalette;

    blueprint.regions.push(blueprintRegion);
  }
...
function getMaterialList(blueprint) {
  var blockCounts = {};
